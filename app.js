...
const paraDisplay = document.getElementById('paraDisplay');
let arrayCount = 0;
let scores = 0;
...
submit.addEventListener("click", function () {
    ...
    if (scores < 6) {
        ...
        percentage.style.fill = 'red';
        paraDisplay.style.color = 'red';
    }
    if (scores >= 6) {
        passFailText.innerHTML = "Congratz You passed !"
        circle.style.stroke = '#07d000';
        percentage.style.fill = '#07d000';
        paraDisplay.style.color = '#07d000';
    }
    if (scores > 8) {
        passFailText.innerHTML = 'You pass with flying colors !'
        circle.style.stroke = '#daa520';
        percentage.style.fill = '#daa520';
        paraDisplay.style.color = '#daa520';
    }
